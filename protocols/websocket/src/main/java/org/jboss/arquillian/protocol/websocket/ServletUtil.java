...
public final class ServletUtil
{
   ...
   public static URI determineBaseURI(WebsocketProtocolConfiguration config, HTTPContext context, String servletName)
   {
      ...
      if(servlet == null) {
          servlet = context.getServletByName("default");
      }
      if(servlet != null)
      {
      ...
      return URI.create("ws://" + address + ":" + port + contextRoot);
   }

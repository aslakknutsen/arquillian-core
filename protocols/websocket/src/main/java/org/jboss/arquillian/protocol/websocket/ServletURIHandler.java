...
public class ServletURIHandler
{
   ...
   private WebsocketProtocolConfiguration config;
    ...
    * 
    */
   public ServletURIHandler(WebsocketProtocolConfiguration config, Collection<HTTPContext> contexts)
   {
      if (config == null)
      {
   ...
   public URI locateTestServlet(Method method)
   {
      ...
      return ServletUtil.determineBaseURI(
               config, 
               context, 
               WebsocketTestRunner.ARQUILLIAN_ENDPOINT_NAME);
   }

 ...
 */
package org.jboss.arquillian.protocol.websocket.v_1;

import static org.jboss.arquillian.protocol.websocket.ServletUtil.APPLICATION_XML_PATH;
...
import org.jboss.arquillian.protocol.websocket.Processor;
import org.jboss.arquillian.protocol.websocket.ServletUtil;
import org.jboss.arquillian.protocol.websocket.arq514hack.descriptors.api.application.ApplicationDescriptor;
 ...
 * @version $Revision: $
 */
public class WebsocketProtocolDeploymentPackager implements DeploymentPackager
{
   /* (non-Javadoc)
   ...
   public Archive<?> generateDeployment(TestDeployment testDeployment, Collection<ProtocolArchiveProcessor> processors)
   {
      ...
      throw new IllegalArgumentException(WebsocketProtocolDeploymentPackager.class.getName()  + 

 ...
 * @version $Revision: $
 */
public abstract class BaseWebsocketProtocol implements Protocol<WebsocketProtocolConfiguration>
{
   /* (non-Javadoc)
    * @see org.jboss.arquillian.spi.client.protocol.Protocol#getProtocolConfigurationClass()
    */
   @Override
   public Class<WebsocketProtocolConfiguration> getProtocolConfigurationClass()
   {
      return WebsocketProtocolConfiguration.class;
   }
    ...
    */
   @Override
   public WebsocketMethodExecutor getExecutor(WebsocketProtocolConfiguration protocolConfiguration, ProtocolMetaData metaData, CommandCallback callback)
   {
      ...
      return new WebsocketMethodExecutor(protocolConfiguration, contexts, callback);
   }

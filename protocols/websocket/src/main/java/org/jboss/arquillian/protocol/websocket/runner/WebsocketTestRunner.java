 ...
 */
@ServerEndpoint(
        value = WebsocketTestRunner.ARQUILLIAN_ENDPOINT_MAPPING,
        encoders = {SerializeEncoder.class},
        decoders = {SerializeDecoder.class})
public class WebsocketTestRunner
{
   public static final String ARQUILLIAN_ENDPOINT_NAME = "ArquillianTestRunner";
   ...
   public void removeSession(Session session) {
       WebsocketTestRunner.session = null;
   }
   
   @OnOpen
   public void storeSession(Session session) {
       WebsocketTestRunner.session = session;
   }
   ...
   public static Command<?> sendCommand(Command<?> command) {
       Session session = WebsocketTestRunner.session;
       if(session == null) {

...
import org.jboss.arquillian.protocol.websocket.runner.WebsocketRemoteExtension;
...
public class ProtocolDeploymentAppender implements AuxiliaryArchiveAppender
{
   ...
   public JavaArchive createAuxiliaryArchive()
   {
      ...
      return ShrinkWrap.create(JavaArchive.class, "arquillian-protocol.jar")
                     .addPackage(WebsocketRemoteExtension.class.getPackage()) // servlet.runner
                     .addAsServiceProvider(RemoteLoadableExtension.class, WebsocketRemoteExtension.class);
   }
}
...
import org.jboss.arquillian.protocol.websocket.TestUtil;
...
import org.jboss.arquillian.protocol.websocket.v_1.WebsocketProtocolDeploymentPackager;
...
public class ServletProtocolDeploymentPackagerTestCase
{
   ...
   {
      Archive<?> archive = new WebsocketProtocolDeploymentPackager().generateDeployment(
            new TestDeployment(
   ...
   public void shouldHandleEnterpriseArchiveWithWebArchive() throws Exception
   {
      ...
      Assert.assertTrue(
            ...
            webXmlContent.contains(WebsocketTestRunner.class.getName()));
   ...
   {
      new WebsocketProtocolDeploymentPackager().generateDeployment(

 ...
 * @version $Revision: $
 */
public class BaseWebsocketProtocolTestCase
{
   @Test
   public void shouldFindTestServletInMetadata() throws Exception
   {
      ...
      HTTPContext testContext = new HTTPContext("127.0.0.1", 8080)
         .add(new Servlet(WebsocketTestRunner.ARQUILLIAN_ENDPOINT_NAME, "test"));
      ...
      Assert.assertEquals("ws://127.0.0.1:8080/test", result.toString());
   }
   ...
   public void shouldOverrideMetadata() throws Exception
   {
      ...
      Assert.assertEquals("ws://10.10.10.1:90/test", result.toString());
   }
   ...
   public void shouldMatchNamedTargetedContext() throws Exception
   {
      ...
      Assert.assertEquals("ws://127.0.0.1:8081/test", result.toString());
   }
   ...
   public void shouldOverrideMatchNamedTargetedContext() throws Exception
   {
      ...
      HTTPContext testContextOne = new HTTPContext("Y", "127.0.0.1", 8080)
         .add(new Servlet(WebsocketTestRunner.ARQUILLIAN_ENDPOINT_NAME, "testY"));

      HTTPContext testContextTwo = new HTTPContext("X", "127.0.0.1", 8081)
         .add(new Servlet(WebsocketTestRunner.ARQUILLIAN_ENDPOINT_NAME, "testX"));
      ...
      Assert.assertEquals("ws://10.10.10.1:90/testX", result.toString());
   }
